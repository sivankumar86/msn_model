/**
 * ExpiredCreditCardNotification.java
 *
...
public class ExpiredCreditCardNotification  extends com.microsoft.adcenter.api.notifications.entities.AccountNotification  implements java.io.Serializable {
    ...
    /**
     * Gets the cardType value for this ExpiredCreditCardNotification.
     * 
     * @return cardType
     */
    ...
    /**
     * Sets the cardType value for this ExpiredCreditCardNotification.
     * 
     * @param cardType
     */
    ...
    /**
     * Gets the lastFourDigits value for this ExpiredCreditCardNotification.
     * 
    ...
    /**
     * Sets the lastFourDigits value for this ExpiredCreditCardNotification.
     * 
    ...
    /**
     * Gets the accountName value for this ExpiredCreditCardNotification.
     * 
     * @return accountName
     */
    ...
    /**
     * Sets the accountName value for this ExpiredCreditCardNotification.
     * 
     * @param accountName
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ExpiredCreditCardNotification)) return false;
        ExpiredCreditCardNotification other = (ExpiredCreditCardNotification) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExpiredCreditCardNotification.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adcenter.microsoft.com/api/notifications/Entities", "ExpiredCreditCardNotification"));
